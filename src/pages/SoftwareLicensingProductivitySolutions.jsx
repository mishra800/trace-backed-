...
<div className="col-md-6" style={{ marginTop: "1rem" }}><img loading="lazy" alt="Cloud Security" src="/assets/images/solutions images/new services/software licensing.avif" style={{ width: "100%", borderRadius: "10px" }}/></div>
</div>
...
<img loading="lazy" alt="Google Workspace" src="/assets/images/partners/Gsuit.jpg" style={{ width: '40px', height: '40px', objectFit: 'contain', flexShrink: 0 }} />
                          Google Workspace
                        </p>
</li>
<li>
...
<img loading="lazy" alt="Office 365" src="/assets/images/partners/MICROSOFT-365-2.jpg" style={{ width: '40px', height: '40px', objectFit: 'contain', flexShrink: 0 }} />
                          Office 365
                        </p>
</li>
<li>
...
<img loading="lazy" alt="Zoom" src="/assets/images/zoom.jpg" style={{ width: '40px', height: '40px', objectFit: 'contain', flexShrink: 0 }} />
                          Zoom
                        </p>
</li>
<li>
...
<img loading="lazy" alt="Adobe" src="/assets/images/adobe.jpg" style={{ width: '40px', height: '40px', objectFit: 'contain', flexShrink: 0 }} />
                          Adobe
                        </p>
</li>
</ul>
...
<img loading="lazy" alt="Bulk SMS" src="/assets/images/bulksms.jpg" style={{ width: '40px', height: '40px', objectFit: 'contain', flexShrink: 0 }} />
                          Bulk SMS
                        </p>
</li>
<li>
...
<img loading="lazy" alt="Business WhatsApp" src="/assets/images/whatsapp.png" style={{ width: '40px', height: '40px', objectFit: 'contain', flexShrink: 0 }} />
                          Business WhatsApp
                        </p>
</li>
<li>
...
<img loading="lazy" alt="Cloud Telephone" src="/assets/images/cloudtelephone.jpg" style={{ width: '40px', height: '40px', objectFit: 'contain', flexShrink: 0 }} />
                          Cloud telephone
                        </p>
</li>
</ul>
