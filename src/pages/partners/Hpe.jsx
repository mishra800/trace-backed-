          ...
          <div className="hpe2-cert-slider">
            <div className="hpe2-cert-track">
              ...
              <div className="hpe2-cert-img-card">
                <img loading="lazy" src="/assets/images/hpe/image1.jpeg" alt="HPE Accredited Solutions Expert — Server Solutions" title="HPE Accredited Solutions Expert — Server Solutions" />
                <span>HPE Accredited Solutions Expert — Server Solutions</span>
              </div>
              <div className="hpe2-cert-img-card">
                <img loading="lazy" src="/assets/images/hpe/image2.jpeg" alt="HPE Sales Certified — Server Solutions" title="HPE Sales Certified — Server Solutions" />
                <span>HPE Sales Certified — Server Solutions</span>
              </div>
              <div className="hpe2-cert-img-card">
                <img loading="lazy" src="/assets/images/hpe/image3.png" alt="HPE Partner Ready Certification" title="HPE Partner Ready Certification" />
                <span>HPE Partner Ready Certification</span>
              </div>
              <div className="hpe2-cert-img-card">
                <img loading="lazy" src="/assets/images/hpe/image4.jpeg" alt="HPE ProLiant Server Infrastructure Specialist" title="HPE ProLiant Server Infrastructure Specialist" />
                <span>HPE ProLiant Server Infrastructure Specialist</span>
              </div>
              {/* Duplicate set for seamless loop */}
              <div className="hpe2-cert-img-card" aria-hidden="true">
                <img loading="lazy" src="/assets/images/hpe/image1.jpeg" alt="" />
                <span>HPE Accredited Solutions Expert — Server Solutions</span>
              </div>
              <div className="hpe2-cert-img-card" aria-hidden="true">
                <img loading="lazy" src="/assets/images/hpe/image2.jpeg" alt="" />
                <span>HPE Sales Certified — Server Solutions</span>
              </div>
              <div className="hpe2-cert-img-card" aria-hidden="true">
                <img loading="lazy" src="/assets/images/hpe/image3.png" alt="" />
                <span>HPE Partner Ready Certification</span>
              </div>
              <div className="hpe2-cert-img-card" aria-hidden="true">
                <img loading="lazy" src="/assets/images/hpe/image4.jpeg" alt="" />
                <span>HPE ProLiant Server Infrastructure Specialist</span>
              </div>
            </div>
          </div>
      ...
      <section className="premium-cards-section" style={{ marginTop: '-20px' }}>
        <div className="premium-container">
          ...
          <div className="premium-card-grid">
            ...
            <div className="premium-service-card"><div className="premium-icon-wrapper"><img loading="lazy" src="/assets/images/agile.png" alt="agile" /></div><p><strong>Flexible MSSP &amp; Pricing Models</strong> Choose from CapEx, OpEx, or MSSP models to align investments with your business goals.</p></div>
          </div>
        </div>
      </section>
