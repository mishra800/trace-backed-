...
export default function Aruba() {
  ...
  useEffect(() => {
    ...
    const wrapper = document.querySelector('.aruba-carousel-wrapper');
    ...
    // Use the wrapper's actual pixel width so the translation is always exact,
    // regardless of how the track/flex layout resolves percentages.
    ...
    // Re-calculate on resize (orientation change on mobile)
    const handleResize = () => updateCarousel(currentSlide);
    window.addEventListener('resize', handleResize);

    // Dot click handlers
    const dotHandlers = [];
    dots.forEach((dot, index) => {
      const handler = () => setCurrentSlide(index);
              ...
              <div className="aruba-cert-slider-wrapper">
                <div className="aruba-cert-images">
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image1.png" alt="Accredited SD-WAN Professional" title="Accredited SD-WAN Professional" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">Accredited SD-WAN Professional</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image2.png" alt="Aruba Certified Switching Professional (ACSP)" title="Aruba Certified Switching Professional (ACSP)" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">Aruba Certified Switching Professional (ACSP)</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image3.png" alt="Aruba HPE Sales Certified Networking Solutions Professional" title="Aruba HPE Sales Certified Networking Solutions Professional" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">Aruba HPE Sales Certified Networking Solutions Professional</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image4.png" alt="HPE Aruba Networking Certified Campus Access Professional" title="HPE Aruba Networking Certified Campus Access Professional" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Certified Campus Access Professional</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image5.png" alt="HPE Aruba Networking Certified Network Security Associate" title="HPE Aruba Networking Certified Network Security Associate" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Certified Network Security Associate</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image6.png" alt="HPE Aruba Networking Certified Network Security Associate" title="HPE Aruba Networking Certified Network Security Associate" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Certified Network Security Associate</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image7.png" alt="HPE Aruba Networking Accredited Central Product Specialist" title="HPE Aruba Networking Accredited Central Product Specialist" />
                    <div className="cert-card-overlay"></div>
                    <span className="cert-tooltip">HPE Aruba Networking Accredited Central Product Specialist</span>
                  </div>
                  <div className="aruba-cert-img-card">
                    <img loading="lazy" src="/assets/images/aruba/image8.png" alt="HPE Aruba Networking Accredited CX 10000 Switch Product Specialist" title="HPE Aruba Networking Accredited CX 10000 Switch Product Specialist" />
                    <div className="cert-card-overlay"></div>
                    ...
                    <div className="aruba-carousel-track">
                      ...
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img loading="lazy" src="/assets/images/aruba/1.png" alt="Aruba NAC" className="aruba-carousel-img" />
                        </div>
                      ...
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img loading="lazy" src="/box2.png" alt="Aruba Switches" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                      ...
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img loading="lazy" src="/assets/images/aruba/1 (2).png" alt="Aruba Access Points" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                      ...
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img loading="lazy" src="/box44.png" alt="Aruba Central Management" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
                      ...
                      <div className="aruba-carousel-slide">
                        <div className="aruba-carousel-image-box">
                          <img loading="lazy" src="/product-access-points-outdoor.jpeg" alt="Aruba Outdoor Access Points" className="aruba-carousel-img" />
                        </div>
                        <div className="aruba-carousel-info">
